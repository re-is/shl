function createGraph(graph) {
	...
	let svgOffset = chart.getElementsByTagName('svg')[0].getBoundingClientRect(),
		...
		trndRel = [[0, Math.ceil(mainLinePoints[1].split(',')[1])], [chartWidth, Math.ceil(mainLinePoints[mainLinePoints.length-2].split(',')[1])]],
	...
	return {
		...
		highest	: { point: { abs: hAbs, rel: hRel }, value: highVal },
		lowest	: { point: { abs: lAbs, rel: lRel }, value: downVal },
